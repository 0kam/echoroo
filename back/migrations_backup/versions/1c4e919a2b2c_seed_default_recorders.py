"""Ensure default recorders exist."""
...
revision = "1c4e919a2b2c"
down_revision = "f9c076e9d88f"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    conn = op.get_bind()
    existing_ids = {
        row.recorder_id for row in conn.execute(sa.select(recorder_table.c.recorder_id))
    }
