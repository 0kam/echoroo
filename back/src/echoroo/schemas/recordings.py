...
from echoroo.schemas.features import Feature
from echoroo.schemas.notes import Note
from echoroo.schemas.tags import Tag
from echoroo.schemas.users import SimpleUser
from echoroo.models.recording import DatetimeParseStatus
...
class RecordingCreate(BaseModel):
    ...
    """Parsed datetime, if already known."""

    h3_index: str | None = None
    """H3 index overriding dataset inheritance."""
...
class Recording(BaseSchema):
    ...
    datetime: dt.datetime | None = None
    """Parsed datetime for the recording."""

    h3_index: str | None = None
    """H3 cell identifier associated with the recording."""

    datetime_parse_status: DatetimeParseStatus
    """Current status of datetime extraction."""

    datetime_parse_error: str | None = None
    """Error message produced while parsing filenames, if any."""
    ...
    """The bit depth of the audio file (e.g., 16, 24, 32).

    This value is automatically extracted from the WAV file header
    during recording registration.
    """
    ...
    """Dataset metadata when included in responses."""
