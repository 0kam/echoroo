...
class FeatureName(Base):
    ...
    * **Recordings:** Contextual information like temperature, wind speed, or
    ...
    if typing.TYPE_CHECKING:
        from echoroo.models.clip import ClipFeature
        from echoroo.models.recording import RecordingFeature
        from echoroo.models.sound_event import SoundEventFeature
