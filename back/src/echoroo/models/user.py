...
Echoroo stores minimal information about users. The only required
...
class User(Base):
    ...
    Use the `create_user` function in the `echoroo.api.users` module instead.
    """
    ...
    if TYPE_CHECKING:
        ...
        from echoroo.models.recording import Recording, RecordingOwner
        from echoroo.models.sound_event_annotation import (
            SoundEventAnnotationTag,
        )
        from echoroo.models.user_run import UserRun
    ...
    project_memberships: orm.Mapped[list["ProjectMember"]] = orm.relationship(
        "ProjectMember",
        back_populates="user",
    ...
    """Project membership assignments for the user."""
