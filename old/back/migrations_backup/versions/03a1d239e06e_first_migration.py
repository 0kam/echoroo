...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("audio_dir", echoroo.models.base.PathType(), nullable=False),
        sa.Column(
            "created_on",
            sa.DateTime().with_variant(
                sa.TIMESTAMP(timezone=True), "postgresql"
    ...
    op.create_table(
        ...
        sa.Column("path", echoroo.models.base.PathType(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "geometry", echoroo.models.base.GeometryType(), nullable=False
        ),
        sa.Column(
            "created_on",
            sa.DateTime().with_variant(
