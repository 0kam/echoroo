...
from echoroo.api.common import (
    BaseAPI,
    create_object,
    delete_object,
    update_object,
...
from echoroo.filters.sound_event_evaluations import ClipEvaluationFilter
...
class ClipEvaluationAPI(
    ...
    async def from_soundevent(
        ...
        -------
        schemas.ClipEvaluation
            The clip evaluation in echoroo format.
        """
    ...
    async def to_soundevent(
        ...
        """Create a clip evaluation in soundevent format from a clip evaluation in echoroo format.
