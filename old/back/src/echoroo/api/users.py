"""Echoroo Python API to interact with user objects in the database."""
...
from echoroo.system.users import (
    SYSTEM_USER_ID,
    UserDatabase,
    UserManager,
)
...
class UserAPI(
    ...
    async def from_soundevent(
        ...
        Raises
        ------
        echoroo.exceptions.DuplicateObjectError
            If a user with the same username or email already exists.
