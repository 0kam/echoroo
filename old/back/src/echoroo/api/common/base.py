...
EchorooModel = TypeVar("EchorooModel", bound=models.Base)
EchorooSchema = TypeVar("EchorooSchema", bound=BaseModel)
...
class BaseAPI(
    ...
    _schema: type[EchorooSchema]
    _model: type[EchorooModel]
    ...
    ) -> tuple[Sequence[EchorooSchema], int]:
        """Get many objects.
    ...
    def _get_from_cache(self, pk: PrimaryKey) -> EchorooSchema:
    ...
    def _update_cache(self, obj: EchorooSchema) -> None:
        """Update the cache.
    ...
    def _clear_from_cache(self, obj: EchorooSchema) -> None:
    ...
    def _get_pk_from_obj(self, obj: EchorooSchema) -> PrimaryKey:
