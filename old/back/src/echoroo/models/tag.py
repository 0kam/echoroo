...
class Tag(Base):
    ...
    if TYPE_CHECKING:
        ...
        from echoroo.models.clip_prediction import ClipPredictionTag
        from echoroo.models.evaluation_set import EvaluationSetTag
        from echoroo.models.recording import Recording, RecordingTag
