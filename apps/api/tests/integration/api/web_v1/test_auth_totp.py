...
def upgraded_db(pg_container: object) -> str:
    # W0 mutation-harness fix #4: run alembic IN-PROCESS instead of shelling out
    # to ``uv run alembic`` (the copied-venv subprocess died under mutmut). See
    # tests/_alembic_upgrade.py for the full rationale.
