    ...
    >
      ...
      <div class="p-6">
        ...
        {#if warningItems.length > 0}
          <div class="rounded-md border border-danger/30 bg-danger-light p-4">
            <div class="mb-3 flex items-center gap-2">
              <svg class="h-5 w-5 flex-shrink-0 text-danger" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <path
              ...
              <span class="text-sm font-medium text-danger">{m.common_delete_warning_items()}</span>
            </div>
            <ul class="m-0 pl-6 text-sm text-danger">
