...
PHASE17_PENDING: frozenset[str] = frozenset(
    [
        ...
        "echoroo/api/v1/annotation_projects.py",
        ...
        "echoroo/api/v1/confirmed_regions.py",
        ...
        "echoroo/middleware/security.py",
        ...
        "echoroo/services/license_service.py",
        ...
        "echoroo/services/restricted_config_service.py",
        ...
        "echoroo/workers/dormancy_check.py",
        ...
        "echoroo/schemas/annotation.py",
        "echoroo/schemas/annotation_comment.py",
        "echoroo/schemas/clip.py",
        "echoroo/schemas/upload.py",
