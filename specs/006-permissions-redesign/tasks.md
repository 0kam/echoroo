...
- [ ] **T324** [US10] Playwright E2E: ライセンス未選択で非活性、CC-BY で作成成功 (PR-003、P1 必須、SC-010)
...
- [ ] **T405** [P] [US3] `apps/api/tests/security/authorization/test_viewer_precise_location_denied.py` TDD: `allow_precise_location_to_viewer=false` 時 Viewer が precise location 取得不可 (FR-022、SC-017)
